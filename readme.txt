=== PayFlexi Installment Payment Plans for LifterLMS ===
Contributors: stanwarri
Tags: flexible payment, installment, layaway, payment plans, courses, online courses, stripe, fast checkout, paystack, flutterwave, online payments, payment gateway
...
1. PayFlexi LifterLMS Payment Gateway Setting Page

2. PayFlexi LifterLMS Payment Gateway on the checkout page

3. PayFlexi Payment Plans Selection

4. PayFlexi LifterLMS Transactions History

5. PayFlexi Merchant Dashboard Schedule History

== Changelog ==

= 1.0.5 - September, 2022 =
*   Added option to disable installment payment and allow only one-time full payment

= 1.0.4 - July 31, 2021 =
*   Fixed bug not automatically enrolling students for one-time payment

= 1.0.3 - July 29, 2021 =
*   Added support for receiving payment directly into a bank account for Nigeria users only 

= 1.0.2 - June 5, 2021 =
*   Added support for Paystack payment gateway

= 1.0.1 - March 20, 2021 =
*   Fix permission callback warning for public rest api
